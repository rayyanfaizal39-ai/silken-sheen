      ...
      <div className="mx-auto max-w-7xl">
        <div className="study-hero-copy mx-auto max-w-4xl animate-fade-up text-center">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <AcademyButton to="/notes" variant="hero" icon={ArrowRight}>
              Start Learning
            </AcademyButton>
            <AcademyButton to="/dashboard" variant="glass" icon={ArrowRight}>
              Continue Learning
            </AcademyButton>
          </div>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-[90] flex items-center justify-center px-4 py-8">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={`Choose what to study for ${subject.label}`}
