...
const sej3Ch2Content: Sej3Ch2Content = {
  hook: {
  ...
  keyTerms: [
    "Francis Light", "Prince of Wales Island", "Province of Wellesley", "Stamford Raffles",
