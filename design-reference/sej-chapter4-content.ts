...
const sej4Content: Sej4Content = {
  ...
  meaningIntro: "Tamadun ditakrifkan sebagai pencapaian tertinggi oleh sesuatu masyarakat dalam pelbagai bidang — pertanian dan perdagangan, sistem pemerintahan, pembentukan bandar, pengkhususan pekerjaan, teknologi, organisasi sosial, agama dan kepercayaan, tulisan dan penyimpanan rekod, serta kesenian dan kesusasteraan.",
  etymology: [
