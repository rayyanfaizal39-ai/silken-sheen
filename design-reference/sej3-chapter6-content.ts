...
const sej3Ch6Content: Sej3Ch6Content = {
  hook: {
  ...
  economicEffects: {
    ...
    railwayPhases: [
      { phase: "Fasa I", years: "1885-1896", details: "Landasan kereta api dibina menghubungkan kawasan lombong dengan pelabuhan untuk eksport bijih timah; turut menghubungkan bandar" },
      { phase: "Fasa II", years: "1897-1909", details: "Landasan menghubungkan utara Tanah Melayu dan selatan apabila NNMB dibentuk" },
      { phase: "Fasa III", years: "1910-1931", details: "British meluaskan pengaruh ke NNMTB; landasan menghubungkan seluruh Tanah Melayu; penggunaan meluas daripada bahan mentah kepada penumpang" }
    ],
  ...
  socialEffects: {
    ...
    education: {
      ...
      schools: [
        { type: "Sekolah Vernakular Melayu", details: ["British tidak berminat memajukan orang Melayu dalam pendidikan", "Hanya bertujuan memberi pengetahuan asas: membaca, menulis, mengira", "Sekolah Melayu pertama: Sekolah Melayu Gelugor, Pulau Pinang (1819)"] },
  ...
  keyExamFacts: [
    ...
    "3 fasa pembinaan landasan kereta api: 1885-1896 (lombong-pelabuhan), 1897-1909 (utara-selatan NNMB), 1910-1931 (seluruh Tanah Melayu, NNMTB)",
