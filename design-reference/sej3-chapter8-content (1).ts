...
export interface Sej3Ch8Content {
  ...
  advisorRefusal: {
    intro: string;
    states: { state: string; advisor: string; appointedDate: string; conflict: string[]; finalTreaty: string; preservedIdentity?: string[] }[];
  };
...
const sej3Ch8Content: Sej3Ch8Content = {
  hook: {
  ...
  bangkokTreatyReactions: {
    ...
    states: [
      ...
      { state: "Kedah", ruler: "Sultan Abdul Hamid Halim Shah (1881-1943)", territorialLoss: "Sadao, Setul, Pulau Terutau, Butang dan pulau sekitarnya kepada Siam", reaction: ["Berasa tersinggung kerana tidak dibawa berunding", "Menegaskan sempadan baharu harus ikut kriteria sedia ada", "Amat murka — menyatakan tidak akan memaafkan sesiapa yang 'menjual negeri Kedah seperti menjual seekor kerbau'"] },
  ...
  johorDiplomacy: {
    ...
    actions: [
      ...
      { action: "Kunjungan ke England, Bertemu Ratu Victoria", details: ["Dikurniakan gelaran Maharaja Johor 1868", "Meredakan tekanan Gabenor Negeri-negeri Selat", "Diberi kepercayaan menyelesaikan pertikaian negeri-negeri Melayu"] },
    ...
    states: [
      ...
      },
      {
        ...
        conflict: [
          ...
          "Surat bantahan Sultan Muhammad IV: '...beta sekali lagi dengan waris-waris negeri ini harap yang tidak ada hajat mengubah peraturan di dalam Negeri Kelantan serta harap tidak ada hajat meletakkan seorang wakil menduduki di dalam negeri kita ini...'"
        ],
  ...
  keyExamFacts: [
    ...
    "Diplomasi Sultan Abu Bakar mengekalkan kedaulatan Johor sehingga 1914",
  ...
  keyTerms: [
    ...
    "Sultan Hisamuddin Alam Shah", "Malay College Kuala Kangsar", "Sultan Abu Bakar",
    "Maharaja Johor", "Lembaga Penasihat Johor", "Sultan Zainal Abidin III"
  ],
  chapterSummary: "Bab 8 mengkaji reaksi pemerintah negeri-negeri Melayu Utara (Perlis, Kedah, Terengganu, Kelantan) terhadap kehilangan wilayah akibat Perjanjian Bangkok 1909, tindakan Raja Melayu menangani cabaran Barat melalui Durbar (1903, 1932, 1937, 1939), keengganan setiap negeri Utara menerima Penasihat British (Perlis hingga 1930, Kedah hingga 1923, Kelantan dan Terengganu melalui perjanjian berasingan), kebijaksanaan diplomasi Sultan Abu Bakar Johor dan Sultan Zainal Abidin III Terengganu, serta usaha pembesar Melayu memodenkan negeri melalui penggubalan perlembagaan bertulis (Undang-Undang Tubuh Kerajaan Johor 1895 — perlembagaan Melayu pertama, dan Undang-Undang Bagi Diri Kerajaan Terengganu 1911) untuk mengukuhkan kuasa pemerintahan dan menghalang campur tangan asing."
};
