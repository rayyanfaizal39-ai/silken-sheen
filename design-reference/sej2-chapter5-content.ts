...
const sej2Ch5Content: Sej2Ch5Content = {
  hook: {
  ...
  keyTerms: [
    ...
    "Lopez de Sequeira", "Lingua franca"
  ],
  chapterSummary: "Bab 5 mengkaji pengasasan Kesultanan Melayu Melaka oleh Parameswara (~1400) di lokasi strategik Sungai Bertam, kegemilangannya melalui kepemimpinan raja berdaulat, Sistem Pembesar Empat Lipatan, sistem perundangan (Hukum Kanun Melaka, Undang-Undang Laut Melaka, Adat Temenggung), empayar luas dan hubungan luar, serta pengakhirannya melalui kelemahan dalaman dan tiga serangan Portugis yang menamatkan Kesultanan Melayu Melaka di Melaka pada 24 Ogos 1511."
};

export default sej2Ch5Content;
