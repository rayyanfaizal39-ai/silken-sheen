...
const sej7Content: Sej7Content = {
  ...
  keyTerms: [
    "Janapada", "Mahajanapada", "Dinasti Nanda", "Dinasti Maurya", "Dinasti Gupta", "Tiang Asoka",
    "Kaviraja", "Dinasti Qin", "Dinasti Han", "Shi Huangdi", "Laluan Sutera", "Konfusianisme",
    "Lun Yu", "Peperiksaan perkhidmatan awam", "Infantri", "Kavalri"
  ],
  chapterSummary: "Bab 7 mengkaji peningkatan Tamadun India (perluasan kuasa fizikal dan keagamaan melalui Dinasti Nanda, Maurya dan Gupta, termasuk transformasi Asoka selepas Perang Kalinga dan zaman keemasan Hindu Gupta) dan Tamadun China (Dinasti Qin dan Han, Laluan Sutera, dan sistem pendidikan lengkap dengan Konfusianisme dan peperiksaan perkhidmatan awam yang kekal sehingga 1905)."
};

export default sej7Content;
