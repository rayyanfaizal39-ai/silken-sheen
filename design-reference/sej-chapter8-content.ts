...
const sej8Content: Sej8Content = {
  ...
  keyTerms: [
    "Zaman Jahiliah", "Kaum Hadhari", "Kaum Badwi", "Assabiyah", "Kabilah", "Syeikh",
    "Wahyu", "Piagam Madinah", "Siddiq", "Amanah", "Tabligh", "Fatanah", "Jihad",
    "Muhajirin", "Ansar", "Mihrab", "Mimbar", "Arabes", "Kaligrafi"
  ],
