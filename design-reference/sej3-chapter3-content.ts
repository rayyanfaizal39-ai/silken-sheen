...
const sej3Ch3Content: Sej3Ch3Content = {
  hook: {
  ...
  residentialSystem: {
    ...
    firstResident: { name: "J.G. Davidson", state: "Perak (Residen pertama)" }
  },
  fmsFormation: {
  ...
  keyExamFacts: [
    ...
    "J.G. Davidson — Residen pertama Perak",
  ...
  keyTerms: [
    ...
    "Perjanjian Pangkor 1874", "HMS Pluto", "Sistem Residen", "J.G. Davidson",
    "Perjanjian Persekutuan 1895", "Residen Jeneral", "Majlis Mesyuarat Persekutuan",
    "Durbar", "Frank Swettenham"
  ],
  chapterSummary: "Bab 3 mengkaji kekayaan bijih timah (merentas 4 era) dan emas (jalur emas Pahang) di Perak, Selangor, Negeri Sembilan dan Pahang, strategi berbeza British meluaskan kuasa di setiap negeri, Perjanjian Pangkor 1874 sebagai titik peralihan penguasaan langsung British, Sistem Residen dan ciri-cirinya, pembentukan Negeri-negeri Melayu Bersekutu melalui Perjanjian Persekutuan 1895, serta struktur pentadbirannya (Majlis Mesyuarat Negeri, Majlis Mesyuarat Persekutuan 1909, Durbar 1897)."
};

export default sej3Ch3Content;
