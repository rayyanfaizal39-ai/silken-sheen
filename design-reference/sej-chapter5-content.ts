...
const sej5Content: Sej5Content = {
  ...
  keyTerms: [
    "Mesopotamia", "Bulan Sabit Subur", "Zigurat", "Kod Hammurabi", "Firaun", "Hieroglif",
    "Hadiah Sungai Nil", "Mohenjo-Daro", "Harappa", "Piktograf", "Kuneiform", "Dinasti Xia",
    "Dinasti Shang", "Dinasti Zhou", "Negara-kota"
  ],
  chapterSummary: "Bab 5 mengkaji empat tamadun awal dunia — Mesopotamia, Mesir Purba, Indus dan Huang He — merangkumi lokasi, kerajaan/dinasti, bandar-bandar utama, dan perbandingan sumbangan merentas 5 aspek: pemerintahan, ekonomi, teknologi, kesenian/kesusasteraan, dan binaan bangunan."
};

export default sej5Content;
