...
const sej3Content: Sej3Content = {
  ...
  stoneAge: [
    { name: "Zaman Paleolitik", altName: "Zaman Batu Lama", duration: "2.5 juta tahun – 8,000 SM", facts: ["Zaman serba mencabar; manusia menggunakan teknologi batu yang ringkas", "Turut menggunakan peralatan daripada tulang binatang"] },
    { name: "Zaman Mesolitik", altName: "Zaman Batu Pertengahan", duration: "12,000 – 4,000 SM", facts: ["Cara hidup semakin berkembang; cuaca tidak terlalu sejuk", "Manusia bukan sahaja memburu tetapi turut menangkap ikan"] },
    { name: "Zaman Neolitik", altName: "Zaman Batu Baru", duration: "10,000 – 2,000 SM", facts: ["Tahap perkembangan teknologi dan corak kehidupan lebih baik", "Wujud kawasan petempatan; aktiviti bercucuk tanam, membuat tembikar, menternak binatang"] }
  ],
  metalAge: {
  ...
  keyTerms: [
    "Zaman Prasejarah", "Nirleka", "Zaman Batu", "Zaman Logam", "Zaman Paleolitik", "Zaman Mesolitik",
    "Zaman Neolitik", "Zaman Hoabinhian", "Ekofak", "Mikrolit", "Animisme", "Ritual", "Ideofak",
    "Organisasi Sosial", "Nomad", "Sara diri", "Komersial"
  ],
  chapterSummary: "Bab 3 menerangkan maksud Zaman Prasejarah dan pembahagiannya kepada Zaman Batu (Paleolitik, Mesolitik, Neolitik) dan Zaman Logam, lokasi tapak prasejarah di dunia dan Asia Tenggara (termasuk Lenggong, Malaysia), tujuh ciri kehidupan manusia prasejarah merentas empat era, enam aktiviti prasejarah yang diteruskan hingga kini, dan bukti Zaman Prasejarah di Malaysia sejak 40,000 tahun lalu merentas Paleolitik, Hoabinhian, Neolitik dan Logam."
};

export default sej3Content;
