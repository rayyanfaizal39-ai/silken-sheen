...
export const BM_FORM2_KOMSAS_WORKS: Form2KomsasWork[] = [
  ...
  {
    id: "talia-dan-raksasa-qadqad",
    title: "Talia dan Raksasa Qadqad",
    category: "Cerpen",
    kind: "story",
  },
...
export const BM_FORM2_NOVEL_WORKS: Form2KomsasWork[] = [
  { id: "meniti-impian", title: "Meniti Impian", category: "Novel", kind: "novel" },
  {
    id: "darah-titik-di-semantan",
    title: "Darah Titik di Semantan",
    category: "Novel",
    kind: "novel",
  },
...
export function getBMForm2KomsasWork(id: string) {
  return [...BM_FORM2_KOMSAS_WORKS, ...BM_FORM2_NOVEL_WORKS].find((work) => work.id === id);
}
