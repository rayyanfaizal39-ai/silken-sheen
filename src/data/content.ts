...
import { scienceF1C8FlashcardsBM } from "./science-f1-c8-flashcards-bm";
...
export const quizzes: QuizQuestion[] = [
  ...
  // Chapter 3: Reading
  {
    ...
    options: [
      ...
      "The central message or most important point of the whole text",
      "A supporting fact or example from the passage",
  ...
  },
  {
    ...
    options: [
      ...
      "The night market was closed due to rain",
  ...
  },
  {
    ...
    options: [
      "Malaysian food is the most delicious in the world.",
      "Kuala Lumpur is the best city to live in.",
  ...
  },
  {
    ...
    chapter: "Chapter 3",
    difficulty: "Easy",
    question: "What is SKIMMING used for?",
    options: [
      "Finding a specific date or name quickly",
      "Reading every word very carefully",
      "Getting the general idea of a passage quickly",
  ...
  },
  {
    ...
    options: [
      ...
      "Exercise improves heart health according to medical studies.",
  ...
  },
  {
    ...
    options: [
      "The title and headings of the passage",
      "Facts, examples, and reasons that back up the main idea",
      "The writer's personal opinions about the topic",
  ...
  },
  {
    ...
    chapter: "Chapter 3",
    difficulty: "Medium",
    question: "In a comprehension exam, when should you read the QUESTIONS?",
    options: [
      "After reading the entire passage twice",
      "Only at the very end when you're done",
      "BEFORE reading the passage — so you know what to look for",
  ...
  },
  {
    ...
    options: [
      ...
      "Hornbills prefer living in cities",
  ...
  // Chapter 4: Writing
  {
    ...
    chapter: "Chapter 4",
    difficulty: "Easy",
    question: "Which is the BEST opening sentence for an essay about a school trip?",
    options: [
      "I am going to write about my school trip.",
      "My school trip was nice and fun.",
      "The bus engine roared to life as we set off on our most unforgettable adventure.",
  ...
  },
  {
    ...
    chapter: "Chapter 4",
    difficulty: "Easy",
    question: "What does TEEL stand for in paragraph writing?",
    options: [
      "Title, Evidence, Explanation, Length",
      "Topic sentence, Evidence, Explanation, Link",
      "Theme, Example, Edit, List",
  ...
  },
  {
    ...
    chapter: "Chapter 4",
    difficulty: "Easy",
    question: "Which sentence uses SENSORY LANGUAGE to describe a durian?",
    options: [
      "The durian was a fruit.",
      "The durian smelled bad.",
      "The durian had a pungent, distinctive aroma that drifted through the entire market.",
  ...
  },
  {
    ...
    chapter: "Chapter 4",
    difficulty: "Medium",
    question: "Upgrade this sentence: 'She walked slowly to school.' Which option is BEST?",
    options: [
      "She walked very very slowly to school.",
      "She trudged wearily to school, her heavy bag dragging at her shoulders.",
      "She was walking slowly and she went to school.",
  ...
  },
  {
    ...
    chapter: "Chapter 4",
    difficulty: "Medium",
    question: "Spot the punctuation error: 'Dear mr. lim i am writing to apply for the position'",
    options: [
      "Missing comma after 'lim'",
      "Missing capitals for 'Mr.', 'Lim', 'I', 'am', and missing comma and full stop",
      "Missing exclamation mark at the end",
  ...
  },
  {
    ...
    chapter: "Chapter 4",
    difficulty: "Medium",
    question: "Which is a feature of INFORMAL writing?",
    options: [
      "No contractions — write 'do not', 'I am', 'cannot'",
      "Use of contractions like I'm, don't, can't, it's",
  ...
  },
  {
    ...
    options: [
      ...
      "The vocabulary is weak, sentences are repetitive, and there are no linking words",
  ...
  },
  {
    ...
    chapter: "Chapter 1",
    difficulty: "Easy",
    question: "Antara berikut, yang manakah merupakan tiga jenis skala yang dipelajari?",
    options: [
      "Skala lurus, skala penyata dan pecahan wakilan",
      "Skala besar, skala kecil dan skala sederhana",
      "Skala mutlak, skala relatif dan skala anggaran",
      "Skala atlas, skala lakar dan skala topografi",
    ],
    answerIndex: 0,
    explanation: "Tiga jenis skala ialah skala lurus, skala penyata dan pecahan wakilan (PW).",
  },
  {
    id: "geo-f2-c1-q3",
    subjectId: "geography",
  ...
  },
  {
    ...
    chapter: "Chapter 1",
    difficulty: "Easy",
    question: "1 : 100 000 merupakan contoh skala jenis apa?",
    options: ["Pecahan wakilan", "Skala lurus", "Skala penyata", "Skala mutlak"],
    answerIndex: 0,
    explanation: "Pecahan wakilan dinyatakan dalam bentuk nisbah tanpa unit, contohnya 1:100 000.",
  },
  {
    id: "geo-f2-c1-q5",
    subjectId: "geography",
  ...
  },
  {
    ...
    chapter: "Chapter 1",
    difficulty: "Easy",
    question: "Berapakah nilai 1 km jika ditukar kepada meter?",
  ...
  // 1.4 Menentukan Jarak Sebenar Berpandukan Skala pada Peta (Q24-30)
  {
    ...
    chapter: "Chapter 1",
    difficulty: "Hard",
    question: "Apakah formula utama untuk menentukan jarak sebenar berpandukan skala pada peta?",
    options: [
      "Jarak Sebenar = Jarak di Peta × Skala",
      "Jarak Sebenar = Skala ÷ Jarak di Peta",
      "Jarak Sebenar = Jarak di Peta ÷ Skala",
      "Jarak Sebenar = Skala − Jarak di Peta",
    ],
    answerIndex: 0,
    explanation: "Formula utama ialah Jarak Sebenar = Jarak di Peta × Skala.",
  },
  {
    id: "geo-f2-c1-q25",
    subjectId: "geography",
...
export const flashcards: Flashcard[] = [
  ...
  // Deck 1 (fc1-20): Konsep Alam Melayu & Kewujudan Kerajaan
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah tiga aspek utama Konsep Alam Melayu?",
    back: "Geografi, bahasa dan budaya.",
  },
  {
    id: "sej-f2-c1-fc2",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah maksud Alam Melayu dari aspek geografi?",
    back: "Gugusan kepulauan dan tanah besar di Asia Tenggara serta kawasan sekitarnya.",
  },
  {
    id: "sej-f2-c1-fc3",
    subjectId: "sejarah",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Bahasa Melayu tergolong dalam keluarga bahasa apa?",
    back: "Keluarga Austronesia.",
  },
  {
    id: "sej-f2-c1-fc5",
    subjectId: "sejarah",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah pusat Kerajaan Funan?",
    back: "Vyadhapura.",
  },
  {
    id: "sej-f2-c1-fc8",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Di manakah lokasi Kerajaan Funan?",
    back: "Lembah Sungai Mekong.",
  },
  {
    id: "sej-f2-c1-fc9",
    subjectId: "sejarah",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah pusat Kerajaan Champa?",
    back: "Indrapura.",
  },
  {
    id: "sej-f2-c1-fc11",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Di manakah lokasi Kerajaan Champa?",
    back: "Selatan dan Tengah Vietnam.",
  },
  {
    id: "sej-f2-c1-fc12",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah pusat Kerajaan Srivijaya?",
    back: "Palembang.",
  },
  {
    id: "sej-f2-c1-fc13",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Di manakah lokasi Kerajaan Srivijaya?",
    back: "Lembah Sungai Musi, Sumatera.",
  },
  {
    id: "sej-f2-c1-fc14",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah pusat Kerajaan Angkor?",
    back: "Hariharalaya.",
  },
  {
    id: "sej-f2-c1-fc15",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Pada abad manakah Kerajaan Angkor mula wujud?",
    back: "Abad Kesembilan.",
  },
  {
    id: "sej-f2-c1-fc16",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Siapakah pengasas Kerajaan Angkor?",
    back: "Jayavarman II.",
  },
  {
    id: "sej-f2-c1-fc17",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah pusat Kerajaan Majapahit?",
    back: "Kota Trowulan.",
  },
  {
    id: "sej-f2-c1-fc18",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Di manakah lokasi Kerajaan Majapahit?",
    back: "Lembah Sungai Brantas, Jawa Timur.",
  },
  {
    id: "sej-f2-c1-fc19",
    subjectId: "sejarah",
  ...
  // Deck 2 (fc21-40): Kerajaan Alam Melayu yang Masyhur
  {
    id: "sej-f2-c1-fc21",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Siapakah pengasas Kerajaan Champa?",
    back: "Chu-Lien.",
  },
  {
    id: "sej-f2-c1-fc22",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Bilakah Kerajaan Champa diasaskan?",
    back: "Tahun 192 Masihi.",
  },
  {
    id: "sej-f2-c1-fc23",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Siapakah pemerintah yang membawa kemasyhuran Kerajaan Funan?",
    back: "Fan Shih-man.",
  },
  {
    id: "sej-f2-c1-fc24",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah faktor kemerosotan Kerajaan Funan?",
    back: "Serangan Kerajaan Chenla.",
  },
  {
    id: "sej-f2-c1-fc25",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Siapakah pemerintah yang membawa zaman kegemilangan Champa?",
    back: "Che Bong Nga.",
  },
  {
    id: "sej-f2-c1-fc26",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Siapakah pengasas Kerajaan Srivijaya?",
    back: "Dapunta Hyang Sri Jayanasa.",
  },
  {
    id: "sej-f2-c1-fc28",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Siapakah tokoh kegemilangan Kerajaan Srivijaya?",
    back: "Sangramadhananjaya.",
  },
  {
    id: "sej-f2-c1-fc29",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah faktor kemerosotan Srivijaya?",
    back: "Serangan tentera Chola dari India pada tahun 1025 yang melemahkan kerajaan.",
  },
  {
    id: "sej-f2-c1-fc30",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah sumbangan Jayavarman VII kepada Angkor?",
    back: "Membina Angkor Thom dan mendirikan 102 buah hospital.",
  },
  {
    id: "sej-f2-c1-fc31",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah faktor kemerosotan Kerajaan Angkor?",
    back: "Serangan Siam pada tahun 1594 selepas kematian Jayavarman VII.",
  },
  {
    id: "sej-f2-c1-fc32",
    subjectId: "sejarah",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Bilakah Kerajaan Majapahit ditubuhkan?",
    back: "Tahun 1294 Masihi.",
  },
  {
    id: "sej-f2-c1-fc34",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah peranan Patih Gajah Mada dalam Majapahit?",
    back: "Mengembalikan keamanan dan meluaskan kuasa Majapahit.",
  },
  {
    id: "sej-f2-c1-fc35",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah faktor kemerosotan Kerajaan Majapahit?",
    back: "Kematian Patih Gajah Mada dan serangan Kesultanan Demak pada tahun 1478.",
  },
  {
    id: "sej-f2-c1-fc36",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Mengapakah Kedah Tua menjadi pusat perdagangan penting?",
    back: "Kedah Tua dikunjungi pedagang Timur dan Barat di Lembah Bujang.",
  },
  {
    id: "sej-f2-c1-fc37",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Siapakah pengasas Gangga Negara menurut sumber tradisi?",
    back: "Raja Ganji Sarjuna.",
  },
  {
    id: "sej-f2-c1-fc38",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah bukti kemasyhuran Gangga Negara?",
    back: "Menjadi pusat pelabuhan penting, dikunjungi pedagang luar serta kaya dengan emas dan bijih timah.",
  },
  {
    id: "sej-f2-c1-fc39",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah bukti Gangga Negara mempertahankan kedaulatannya?",
    back: "Berjaya mempertahankan diri daripada serangan Srivijaya pada tahun 850 Masihi.",
  },
  {
    id: "sej-f2-c1-fc40",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah faktor kemerosotan Gangga Negara?",
    back: "Serangan tentera Chola pada tahun 1025 yang memusnahkan pelabuhannya.",
  },

  // Deck 3 (fc41-60): Hubungan Dengan Kerajaan Luar
  {
    id: "sej-f2-c1-fc41",
    subjectId: "sejarah",
    form: "Form 2",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah sumbangan Suryavarman II kepada Angkor?",
    back: "Meluaskan empayar hingga selatan Myanmar dan menghalang ancaman Champa serta Dai Viet.",
  },
  {
    id: "sej-f2-c1-fc43",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah kejayaan Che Bong Nga terhadap Dai Viet?",
    back: "Menyerang Dai Viet sehingga Raja Tran Due Tong terbunuh.",
  },
  {
    id: "sej-f2-c1-fc44",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Bilakah Champa mendapat pengiktirafan Dinasti Ming?",
    back: "Tahun 1369.",
  },
  {
    id: "sej-f2-c1-fc45",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Mengapakah Srivijaya menjadi kuasa perdagangan utama Alam Melayu?",
    back: "Srivijaya menguasai Selat Melaka dan Selat Sunda.",
  },
  {
    id: "sej-f2-c1-fc46",
    subjectId: "sejarah",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah kerajaan luar yang sezaman dengan Funan pada abad pertama?",
    back: "Empayar Rom, Empayar Parsi, Empayar Kushan dan Dinasti Han.",
  },
  {
    id: "sej-f2-c1-fc48",
    subjectId: "sejarah",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah tiga bentuk hubungan kerajaan Alam Melayu dengan kerajaan luar?",
    back: "Perdagangan, keagamaan dan diplomatik.",
  },
  {
    id: "sej-f2-c1-fc51",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah faktor hubungan perdagangan kerajaan Alam Melayu dengan kerajaan luar?",
    back: "Kedudukan strategik, laluan perdagangan Timur-Barat dan kekayaan hasil bumi.",
  },
  {
    id: "sej-f2-c1-fc52",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Namakan empat pelabuhan penting Alam Melayu dalam perdagangan antarabangsa.",
    back: "Oc Eo, Kedah Tua, Palembang dan Tuban.",
  },
  {
    id: "sej-f2-c1-fc53",
    subjectId: "sejarah",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Bagaimanakah agama Hindu tersebar ke Alam Melayu?",
    back: "Melalui pedagang, tentera dan golongan Brahmin.",
  },
  {
    id: "sej-f2-c1-fc55",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Bagaimanakah agama Buddha tersebar ke Alam Melayu?",
    back: "Melalui peranan Maharaja Asoka dan sami Buddha yang dihantar ke Alam Melayu.",
  },
  {
    id: "sej-f2-c1-fc56",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Bagaimanakah agama Islam tersebar ke Alam Melayu?",
    back: "Melalui pedagang, pemerintah dan pendakwah.",
  },
  {
    id: "sej-f2-c1-fc57",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah maksud hubungan diplomatik?",
    back: "Hubungan politik antara dua kerajaan.",
  },
  {
    id: "sej-f2-c1-fc58",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah tujuan hubungan diplomatik kerajaan Alam Melayu?",
    back: "Mengukuhkan kedudukan kerajaan, membuka jalan perdagangan dan menjalin persahabatan.",
  },
  {
    id: "sej-f2-c1-fc59",
    subjectId: "sejarah",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Mengapakah Srivijaya berhubung dengan China pada abad ketujuh?",
    back: "Untuk mendapatkan pengiktirafan, memperkukuh perdagangan dan mengukuhkan persahabatan.",
  },
  {
    id: "sej-f2-c1-fc60",
    subjectId: "sejarah",
  ...
  ...scienceF1C8FlashcardsBM,
  ...scienceF1C8FlashcardsDLP,
  ...scienceF1C9FlashcardsBM,
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Namakan tiga jenis skala.",
    back: "Skala lurus, skala penyata dan pecahan wakilan.",
  },
  {
    id: "geo-f2-c1-fc3",
    subjectId: "geography",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Berikan contoh skala penyata.",
    back: "1 cm mewakili 1 km.",
  },
  {
    id: "geo-f2-c1-fc4",
    subjectId: "geography",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Berikan contoh pecahan wakilan.",
    back: "1 : 100 000.",
  },
  {
    id: "geo-f2-c1-fc5",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah bentuk skala lurus?",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah maksud jarak mutlak?",
    back: "Jarak yang diukur dalam unit ukuran seperti meter atau kilometer dan nilainya tetap.",
  },
  {
    id: "geo-f2-c1-fc7",
    subjectId: "geography",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah maksud jarak relatif?",
    back: "Jarak yang diukur berdasarkan masa, kos atau jenis pengangkutan dan boleh berubah.",
  },
  {
    id: "geo-f2-c1-fc8",
    subjectId: "geography",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah unit ukuran bagi jarak mutlak?",
    back: "Meter (m) atau kilometer (km).",
  },
  {
    id: "geo-f2-c1-fc10",
    subjectId: "geography",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Namakan alat untuk mengukur jarak lurus di atas peta.",
    back: "Pembaris, jangka tolok dan jalur kertas.",
  },
  {
    id: "geo-f2-c1-fc12",
    subjectId: "geography",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Namakan alat untuk mengukur jarak melengkung di atas peta.",
    back: "Benang dan jalur kertas.",
  },
  {
    id: "geo-f2-c1-fc13",
    subjectId: "geography",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah fungsi jangka tolok dalam mengukur jarak?",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah yang perlu dilakukan kepada benang selepas dilenturkan mengikut lengkok sungai?",
  ...
  },
  {
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "Apakah yang perlu dilakukan jika skala diberikan dalam bentuk pecahan wakilan?",
    back: "Tukarkan kepada skala penyata (contoh: 1 cm mewakili 1 km) dahulu sebelum mengira.",
  },
  {
    id: "geo-f2-c1-fc18",
    subjectId: "geography",
    form: "Form 2",
    chapter: "Chapter 1",
    front: "1 km bersamaan dengan berapa meter?",
    back: "1 000 meter.",
  },
  {
    id: "geo-f2-c1-fc19",
    ...
    form: "Form 2",
    chapter: "Chapter 1",
    front: "1 meter bersamaan dengan berapa sentimeter?",
    back: "100 sentimeter.",
  },
  {
    id: "geo-f2-c1-fc20",
...
export function geographyChapterFromId(id: string): number | null {
  const m = id.match(/^geo-f[123]-c(\d+)-/);
  return m ? parseInt(m[1], 10) : null;
}
export interface ChapterItem {
  ...
  label: string;
  available: boolean;
  /** Allows an unavailable chapter card to open a structured placeholder. */
  selectable?: boolean;
  /** Future note sections shown while chapter content is being prepared. */
  subtopics?: string[];
  isNew?: boolean;
}
...
export function getSubjectChapters(
  ...
  if (form === "Form 2" && subjectId === "sejarah") {
    return [
      ...
      {
        key: "Chapter 3",
        label: "Chapter 3: Sosiobudaya Masyarakat Kerajaan Alam Melayu",
        available: true,
        isNew: true,
      },
      {
      ...
      {
        key: "Chapter 6",
        label: "Chapter 6: Kesultanan Johor Riau",
        available: false,
        selectable: true,
        subtopics: [
      ...
      {
        key: "Chapter 9",
        label: "Chapter 9: Warisan Kerajaan Kedah, Kelantan, Negeri Sembilan dan Perlis",
        available: true,
        selectable: true,
        subtopics: [
      ...
      {
        key: "Chapter 10",
        label: "Chapter 10: Sarawak dan Sabah",
        available: true,
        selectable: true,
        subtopics: [
  ...
  if (form === "Form 2" && subjectId === "geography") {
    return [
      ...
      {
        key: "Chapter 7",
        label: "Chapter 7: Kepelbagaian Iklim dan Pengaruhnya terhadap Kegiatan Manusia di Asia",
        available: true,
      },
      {
        key: "Chapter 8",
        label: "Chapter 8: Jenis dan Kemajuan Pengangkutan di Asia",
        available: true,
      },
