...
export const flashcards: Flashcard[] = [
  ...
  { id: "sej-f1-c1-fc1", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud sejarah dari sudut bahasa Arab?", back: "Berasal daripada perkataan 'syajaratun' yang bermaksud pokok." },
  { id: "sej-f1-c1-fc2", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Sejarah dalam bahasa Melayu dikaitkan dengan apa?", back: "Dikaitkan dengan salasilah, asal usul, riwayat, dan keturunan." },
  { id: "sej-f1-c1-fc3", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud istilah 'historia' dalam bahasa Yunani?", back: "Bermaksud penyelidikan atau penyiasatan." },
  { id: "sej-f1-c1-fc4", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud 'history' dalam bahasa Inggeris?", back: "Cerita tentang seseorang atau penyelidikan tentang peristiwa masa lalu." },
  { id: "sej-f1-c1-fc5", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Siapakah yang dianggap sebagai Bapa Sejarah?", back: "Herodotus." },
  { id: "sej-f1-c1-fc6", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Bagaimanakah Herodotus mentakrifkan sejarah?", back: "Penceritaan tentang tindakan manusia yang mengagumkan dan sebab berlakunya sesuatu peristiwa." },
  { id: "sej-f1-c1-fc7", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah fokus sejarah menurut E.H. Carr?", back: "Suatu proses interaksi berterusan antara ahli sejarah dengan fakta-faktanya." },
  { id: "sej-f1-c1-fc8", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud sejarah menurut Ibn Khaldun?", back: "Membicarakan tentang masyarakat manusia, peradaban dunia, dan perubahan pada watak masyarakat tersebut." },
  { id: "sej-f1-c1-fc9", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah definisi sejarah oleh Khoo Kay Kim?", back: "Sejarah merujuk kepada apa-apa yang pernah atau sudah berlaku." },
  { id: "sej-f1-c1-fc10", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah pandangan Muhd Yusof Ibrahim tentang sejarah?", back: "Sejarah merupakan catatan atau rekod tentang sesuatu peristiwa yang berlaku pada masa lalu." },
  { id: "sej-f1-c1-fc11", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah yang dimaksudkan dengan masa silam?", back: "Rentetan peristiwa yang telah berlaku mengikut urutan masa." },
  { id: "sej-f1-c1-fc12", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud kronologi?", back: "Urutan waktu kejadian sesuatu peristiwa yang berlaku secara teratur." },
  { id: "sej-f1-c1-fc13", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Berapakah tempoh masa bagi satu dekad?", back: "10 tahun." },
  { id: "sej-f1-c1-fc14", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Berapakah tempoh masa bagi satu abad?", back: "100 tahun." },
  { id: "sej-f1-c1-fc15", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Berapakah tempoh masa bagi satu alaf?", back: "1000 tahun." },
  { id: "sej-f1-c1-fc16", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud Sebelum Masihi (SM)?", back: "Zaman sebelum kelahiran Nabi Isa AS." },
  { id: "sej-f1-c1-fc17", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud Masihi (M)?", back: "Zaman yang bermula selepas kelahiran Nabi Isa AS." },
  { id: "sej-f1-c1-fc18", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Mengapakah konsep masa penting dalam sejarah?", back: "Untuk memudahkan kita memahami urutan peristiwa yang berlaku." },
  { id: "sej-f1-c1-fc19", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah yang dimaksudkan dengan ruang dalam sejarah?", back: "Kawasan atau tempat berlakunya sesuatu peristiwa." },
  { id: "sej-f1-c1-fc20", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah kepentingan pembahagian zaman dalam sejarah?", back: "Untuk memudahkan kajian dan pemahaman tentang perubahan masa." },
  { id: "sej-f1-c1-fc21", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah yang dimaksudkan dengan sumber primer?", back: "Sumber yang bersifat asli, belum diolah, ditafsir, atau diterbitkan." },
  { id: "sej-f1-c1-fc22", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah yang dimaksudkan dengan sumber sekunder?", back: "Bahan yang telah diolah, ditafsir, dan diterbitkan untuk rujukan umum." },
  { id: "sej-f1-c1-fc23", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Berikan contoh sumber primer yang berupa hidupan.", back: "Fosil." },
  { id: "sej-f1-c1-fc24", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud artifak?", back: "Peralatan atau barang buatan manusia yang mempunyai kepentingan sejarah." },
  { id: "sej-f1-c1-fc25", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Berikan contoh artifak.", back: "Loceng gangsa, tembikar, dan mata wang." },
  { id: "sej-f1-c1-fc26", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud bukan artifak?", back: "Data arkeologi berkaitan budaya yang terdapat di sesuatu tapak seperti dinding gua." },
  { id: "sej-f1-c1-fc27", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Adakah manuskrip dianggap sebagai sumber primer?", back: "Ya, jika ia adalah catatan asal yang belum diterbitkan." },
  { id: "sej-f1-c1-fc28", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Berikan contoh sumber sekunder.", back: "Buku teks, majalah, surat khabar, dan ensiklopedia." },
  { id: "sej-f1-c1-fc29", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Mengapakah sumber primer lebih dipercayai?", back: "Kerana ia merupakan bukti langsung daripada masa peristiwa itu berlaku." },
  { id: "sej-f1-c1-fc30", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Di manakah biasanya sumber primer disimpan?", back: "Di arkib atau muzium." },
  { id: "sej-f1-c1-fc31", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah peranan diari sebagai sumber sejarah?", back: "Ia merupakan sumber primer yang merekodkan pengalaman peribadi seseorang." },
  { id: "sej-f1-c1-fc32", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Adakah jurnal dianggap sumber primer atau sekunder?", back: "Bergantung kepada kandungannya; jurnal akademik biasanya sumber sekunder." },
  { id: "sej-f1-c1-fc33", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah kepentingan memelihara sumber sejarah?", back: "Agar generasi akan datang dapat mengkaji bukti sejarah yang asli." },
  { id: "sej-f1-c1-fc34", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud batu bersurat?", back: "Batu yang mengandungi tulisan atau catatan sejarah masa lalu." },
  { id: "sej-f1-c1-fc35", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah dokumen rasmi sebagai sumber primer?", back: "Catatan pentadbiran atau surat rasmi kerajaan." },
  { id: "sej-f1-c1-fc36", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Nyatakan tiga kaedah penyelidikan sejarah.", back: "Kaedah bertulis, kaedah lisan, dan kaedah arkeologi." },
  { id: "sej-f1-c1-fc37", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah kaedah bertulis?", back: "Mendapatkan maklumat daripada catatan pada batu, dinding gua, kulit kayu, atau kertas." },
  { id: "sej-f1-c1-fc38", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah kaedah lisan?", back: "Mendapatkan maklumat melalui temubual dengan tokoh atau saksi peristiwa." },
  { id: "sej-f1-c1-fc39", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Siapakah 'orang sumber'?", back: "Orang yang memberikan maklumat dalam kaedah lisan berdasarkan ingatan atau pemerhatian mereka." },
  { id: "sej-f1-c1-fc40", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah kaedah arkeologi?", back: "Kaedah saintifik untuk mendapatkan maklumat daripada bahan tinggalan sejarah melalui aktiviti gali cari." },
  { id: "sej-f1-c1-fc41", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah tujuan aktiviti gali cari (ekskavasi)?", back: "Untuk menemukan bahan-bahan sejarah yang tertanam di bawah permukaan tanah." },
  { id: "sej-f1-c1-fc42", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah arkeologi bawah air?", back: "Kajian saintifik tentang peninggalan sejarah yang tenggelam di dasar laut atau tasik." },
  { id: "sej-f1-c1-fc43", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Berikan contoh penemuan arkeologi bawah air.", back: "Bangkai kapal dagang purba dan seramik." },
  { id: "sej-f1-c1-fc44", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah langkah pertama dalam kaedah lisan?", back: "Mengenal pasti tokoh atau orang sumber." },
  { id: "sej-f1-c1-fc45", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah langkah terakhir dalam kaedah bertulis?", back: "Menganalisis dan mentafsir maklumat yang diperolehi." },
  { id: "sej-f1-c1-fc46", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah yang dimaksudkan dengan pentafsiran sejarah?", back: "Tindakan menerangkan atau mengulas sesuatu fakta sejarah berdasarkan sumber." },
  { id: "sej-f1-c1-fc47", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Mengapakah wujud perbezaan tafsiran dalam sejarah?", back: "Disebabkan perbezaan pandangan, ideologi, dan pemilihan sumber yang pelbagai." },
  { id: "sej-f1-c1-fc48", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Adakah tafsiran sejarah boleh berubah?", back: "Ya, sekiranya ditemui sumber baharu yang lebih sahih." },
  { id: "sej-f1-c1-fc49", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah tujuan pentafsiran sejarah yang objektif?", back: "Untuk mendapatkan kebenaran tentang sesuatu peristiwa masa lalu." },
  { id: "sej-f1-c1-fc50", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Berikan contoh tafsiran yang berbeza tentang tokoh sejarah.", back: "Tok Janggut dianggap pejuang oleh rakyat tempatan tetapi dianggap penderhaka oleh British." },
  { id: "sej-f1-c1-fc51", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Mengapakah kita perlu mengenal asal usul melalui sejarah?", back: "Untuk mengetahui latar belakang keluarga, bangsa, dan negara kita." },
  { id: "sej-f1-c1-fc52", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah maksud mengambil iktibar daripada sejarah?", back: "Belajar daripada kejayaan atau kegagalan masa lalu untuk masa depan yang lebih baik." },
  { id: "sej-f1-c1-fc53", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Bagaimanakah sejarah memupuk semangat patriotisme?", back: "Dengan menghargai warisan negara dan berasa bangga akan tanah air." },
  { id: "sej-f1-c1-fc54", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Bagaimanakah sejarah mengukuhkan perpaduan?", back: "Dengan memahami sejarah dan budaya kaum lain untuk hidup harmoni." },
  { id: "sej-f1-c1-fc55", subjectId: "sejarah", form: "Form 1", chapter: "Chapter 1", front: "Apakah peranan sejarah dalam membangunkan pemikiran kritis?", back: "Mengajar kita menilai fakta secara rasional dan tidak mudah terpengaruh dengan khabar angin." },
