...
export const sejarahF3C5Flashcards: Flashcard[] = makeCards().map(([front, back], index) => ({
  id: `sej-f3-c5-fc${index + 1}`,
  subjectId: "sejarah",
  form: "Form 3",
  chapter: "Chapter 5",
  front,
