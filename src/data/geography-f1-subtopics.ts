...
export const geographyF1Subtopics: Record<string, Subtopic[]> = {
  "Chapter 1": [
    ...
    },
    {
      ...
      keywords: ["Matahari Terbit", "Matahari Terbenam", "Buruj", "Buruj Biduk", "Kaedah Semula Jadi"],
    },
    {
      key: "geo-c1-s3",
      num: 3,
  ...
  "Chapter 11": [
    ...
    },
    {
      ...
      keywords: ["Kuala Lumpur", "Bangkok", "Jakarta", "Manila", "Singapura", "Pelabuhan", "Hab Perdagangan"],
    },
  ],
  "Chapter 12": [
    {
