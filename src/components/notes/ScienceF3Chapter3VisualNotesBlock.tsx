...
const copy = {
  bm: {
    ...
    title: "Pengangkutan",
    subtitle: "Sistem pengangkutan dalam organisma, sistem peredaran darah, darah manusia, pengangkutan dalam tumbuhan, sistem peredaran darah dalam haiwan dan sistem pengangkutan dalam tumbuhan.",
    roadmap: [
      ...
      ["3.5 Sistem Peredaran Darah dalam Haiwan dan Sistem Pengangkutan dalam Tumbuhan", "Bagaimana dua sistem berbeza menyelesaikan masalah pengangkutan yang sama."],
    ],
  ...
  en: {
    ...
    title: "Transport",
    subtitle: "Transport system in organisms, blood circulatory system, human blood, transport system in plants, blood circulatory system in animals and transport system in plants.",
    roadmap: [
      ["3.1 Transport System in Organisms", "Why large organisms need specialised systems instead of diffusion alone."],
      ...
      ["3.4 Transport System in Plants", "How transpiration, stomata, xylem and phloem move substances."],
      ["3.5 Blood Circulatory System in Animals and Transport System in Plants", "How two different systems solve the same transport problem."],
    ],
