...
const copy = {
  bm: {
    ...
    title: "Termokimia",
    subtitle: "Tindak balas endotermik dan eksotermik.",
    roadmap: [
      ["Cari kawasan tindak balas kimia berlaku."],
      ["Adakah haba keluar atau masuk ke dalam sistem?"],
      ["Suhu persekitaran meningkat atau menurun?"],
      ["Kelaskan tindak balas dan reka aplikasi yang sesuai."],
    ],
    bigIdea: "Idea besar",
    visual: "Lihat konsep",
    ...
    hide: "Tutup jawapan",
    introTitle: "Tindak Balas Endotermik dan Eksotermik",
    ...
    compareTitle: "Perbandingan dan Perbezaan Utama",
    exo: "Eksotermik",
    ...
    experimentTitle: "Aktiviti Inkuiri 5.1: Membandingkan Tindak Balas Eksotermik dan Endotermik",
    ...
    dailyTitle: "Contoh Tindak Balas Eksotermik dan Endotermik dalam Kehidupan Harian",
    designTitle: "Rekaan STEM dan Aplikasi Kejuruteraan Termokimia",
    ...
    thermiteTitle: "Aplikasi Industri: Tindak Balas Termit",
  ...
  en: {
    ...
    subtitle: "Endothermic and exothermic reactions.",
    roadmap: [
      ["Find where the chemical reaction occurs."],
      ["Does heat leave or enter the system?"],
      ["Does the surroundings' temperature rise or fall?"],
      ["Classify the reaction and design a suitable application."],
    ],
    bigIdea: "Big idea",
    ...
    hide: "Hide answer",
    introTitle: "Endothermic and Exothermic Reactions",
    ...
    compareTitle: "Main Comparison and Differences",
    exo: "Exothermic",
    ...
    experimentTitle: "Inquiry Activity 5.1: Comparing Exothermic and Endothermic Reactions",
    ...
    dailyTitle: "Examples of Exothermic and Endothermic Reactions in Daily Life",
    designTitle: "STEM Design and Thermochemistry Engineering Applications",
    ...
    thermiteTitle: "Industrial Application: Thermite Reaction",
