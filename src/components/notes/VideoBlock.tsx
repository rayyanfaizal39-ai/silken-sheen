...
const VIDEO_COPY = {
  en: { heading: "Educational", headingAccent: "Videos", chip: "Watch and Learn" },
  bm: { heading: "Video", headingAccent: "Pendidikan", chip: "Tonton dan Belajar" },
} as const;
...
export function VideoBlock({
  ...
  id?: string;
  /** Defaults to English so every existing caller keeps its current chrome. */
  lang?: "en" | "bm";
}) {
  const t = VIDEO_COPY[lang];
