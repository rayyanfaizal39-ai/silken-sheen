...
const copy = {
  bm: {
    eyebrow: "Bab 1",
    title: "Rangsangan dan Gerak Balas",
    roadmap: [
      ["1.1 Sistem Saraf Manusia", "Bagaimana otak, saraf tunjang dan saraf periferi mengesan rangsangan lalu menyelaras gerak balas."],
      ["1.2 Rangsangan dan Gerak Balas dalam Manusia", "Bagaimana lima organ deria menerima cahaya, bunyi, bahan kimia dan sentuhan."],
      ["1.3 Rangsangan dan Gerak Balas dalam Tumbuhan", "Bagaimana tumbuhan bertindak balas terhadap cahaya, graviti, air dan sentuhan."],
      ["1.4 Kepentingan Gerak Balas terhadap Rangsangan dalam Haiwan Lain", "Bagaimana penglihatan, pendengaran dan organ deria khas membantu haiwan terus hidup."],
    ],
  ...
  en: {
    ...
    roadmap: [
      ...
      ["1.2 Stimuli and Responses in Humans", "How the five sensory organs receive light, sound, chemicals and touch."],
      ["1.3 Stimuli and Responses in Plants", "How plants respond to light, gravity, water and touch."],
      ["1.4 Importance of Responses to Stimuli in Other Animals", "How vision, hearing and special sensory organs help animals survive."],
    ],
