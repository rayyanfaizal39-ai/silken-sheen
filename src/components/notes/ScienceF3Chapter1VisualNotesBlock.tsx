...
const copy = {
  ...
  en: {
    ...
    subtitle: "Human nervous system, stimuli and responses in humans, stimuli and responses in plants, and the importance of responses to stimuli in other animals.",
    roadmap: [
