...
import { MAHKAMAH as note } from "@/data/bm-form2-mahkamah";
...
export function BMForm2MahkamahContent() {
  return (
    <div>
      <Section
        title="Bukti diteliti, keadilan ditegakkan"
      ...
      <Section title="Sinopsis" eyebrow="Ringkasan Drama" color="#A78BFA">
      ...
      <Section title="Pemikiran" eyebrow="Idea Utama" color="#F472B6">
      ...
      <Section title="Latar" eyebrow="Dunia Drama" color="#A78BFA">
        <div className="space-y-5">
