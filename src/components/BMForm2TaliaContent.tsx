...
import { TALIA_DAN_RAKSASA_QADQAD as note } from "@/data/bm-form2-talia-dan-raksasa-qadqad";
...
export function BMForm2TaliaContent() {
  return (
    <div>
      <Section
        title="Kebaikan dikenang, alam dipertahankan"
