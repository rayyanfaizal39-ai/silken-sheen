...
.academy-static-stars{position:absolute;inset:0;opacity:.48;pointer-events:none;background-image:radial-gradient(circle at 13% 20%,#fff 0 1px,transparent 1.5px),radial-gradient(circle at 77% 16%,#fff 0 1px,transparent 1.5px),radial-gradient(circle at 30% 72%,#fff 0 1px,transparent 1.5px),radial-gradient(circle at 88% 78%,#fff 0 1px,transparent 1.5px),radial-gradient(circle at 55% 42%,#fff 0 1px,transparent 1.5px);background-size:170px 170px;animation:academy-static-twinkle 3.2s ease-in-out infinite}
