...
function englishFlashcardsFor(chapterKey: string, form: ChapterContent["form"] = "Form 1") {
...
function englishQuizzesFor(chapterKey: string, form: ChapterContent["form"] = "Form 1") {
