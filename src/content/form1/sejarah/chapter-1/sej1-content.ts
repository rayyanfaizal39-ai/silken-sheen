...
export const sej1Content: Sej1Content = {
  hook: {
  ...
  definition: {
    general:
      "Secara umumnya, sejarah ialah peristiwa yang berlaku pada masa lalu. Peristiwa masa lalu yang berlaku dalam kehidupan sesebuah masyarakat atau negara akan dikaji oleh sejarawan.",
    etymology: [
      {
        language: "Bahasa Melayu",
        origin: "Perkataan Arab 'syajaratun'",
        meaning: "Bermaksud pokok; turut dikaitkan dengan salasilah, riwayat, keturunan dan asal usul",
      },
      {
        language: "Kamus Dewan",
        origin: "Definisi rasmi",
        meaning:
          "Asal usul (keturunan), salasilah; peristiwa yang benar-benar berlaku pada waktu lampau; kajian tentang peristiwa yang telah lalu",
      },
      {
        language: "Bahasa Inggeris",
        origin: "'History', daripada bahasa Yunani 'historia'",
        meaning: "Bermaksud cerita tentang seseorang; 'historia' bermaksud penyelidikan",
      },
    ],
  },
  historianViews: [
    {
      ...
      work: "Histories (Sejarah Perang Parsi)",
    },
    {
      name: "E.H. Carr",
      quote:
    ...
    },
    {
      name: "Khoo Kay Kim",
      quote:
        "Sejarah merujuk kepada apa-apa yang pernah atau sudah berlaku. Sejarah mendorong kita lebih memahami apa-apa yang berlaku pada masa kini... Sejarah ialah ibu kepada semua bidang.",
      work: "Sejarawan tempatan tersohor Malaysia",
    },
  ],
  timeAndSpace: {
    chronologyDefinition:
      "Masa silam dikaji berdasarkan urutan masa yang dinamakan kronologi — rentetan peristiwa yang berlaku secara teratur mengikut urutan masa dari awal hingga terakhir, bergerak mengikut satu garis lurus.",
    timeUnits: [
    ...
    eraSystem:
      "Konsep masa turut diukur mengikut zaman: Sebelum Masihi (SM) dan Masihi (M). Zaman Masihi bermula dengan kelahiran Nabi Isa AS.",
  ...
  sources: {
    ...
    realExamples: [
      {
        name: "Loceng Gangsa",
        location: "Kampung Pencu, Muar, Johor",
        significance: "Dihasilkan sekitar 150 Masihi — sumber untuk melihat hubungan perdagangan dengan kerajaan Funan",
      },
      {
        name: "Candi Lembah Bujang",
        location: "Kedah",
        significance: "Menunjukkan pengaruh Hindu dan Buddha serta hubungan perdagangan antara India dengan Kedah",
      },
      {
        name: "Batu Bersurat Terengganu",
        location: "Terengganu",
        significance: "Bertarikh 702 Hijrah (1303 Masihi) — bukti agama Islam sudah bertapak di negara kita lebih awal dari tarikh ini",
      },
    ],
  },
  researchMethods: [
  ...
  interpretation: {
    ...
    example: {
      ...
      localView:
        "Pengkaji tempatan melihat faktor kebangkitan beliau disebabkan penentangan peraturan cukai tanah dan hasil hutan yang diperkenalkan British",
