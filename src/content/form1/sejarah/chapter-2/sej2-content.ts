...
export const sej2Content: Sej2Content = {
  hook: {
  ...
  ourWorld: {
    intro:
      "Pengetahuan tentang sejarah bukan sahaja membolehkan kita mengenali diri kita tetapi juga memahami tentang dunia. Bumi pada hari ini telah melalui pelbagai perubahan yang memberikan kesan terhadap rupa bentuk fizikal, iklim, cuaca, hidupan dan kedalaman lautan.",
  ...
  iceAgeOverview: {
    definition:
      "Zaman Air Batu ialah garis masa geologi yang menunjukkan suhu bumi menurun ke tahap membeku dalam jangka masa yang lama. Kutub Utara dan Selatan diliputi lapisan ais tebal.",
    glaciationStages: [
      "Tahap pertama: 900 hingga 600 juta tahun dahulu",
      "Tahap kedua: 250 hingga 80,000 juta tahun dahulu",
      "Tahap ketiga: 10,000 juta tahun dahulu",
    ],
  ...
  epochs: [
    {
      name: "Zaman Miosen",
      duration: "23 juta hingga 5 juta tahun dahulu",
      facts: ["Gunung-ganang hari ini terbentuk secara fizikal", "Mamalia wujud dan berkembang di bumi, laut dan air", "Suhu dunia panas dan kering"],
    },
    {
      name: "Zaman Pliosen",
      duration: "5.3 juta hingga 2.6 juta tahun dahulu",
      facts: [
        "Berlaku penyejukan global berbanding Zaman Miosen yang lebih panas",
        "Penyebaran besar padang rumput dan savana",
        "Jambatan darat Panama antara Amerika Utara dan Selatan terbentuk",
        "Grand Canyon (Colorado) terbentuk pada zaman ini",
      ],
    },
    {
      name: "Zaman Pleistosen",
      duration: "2.5 juta hingga 10,000 tahun dahulu",
      facts: [
        "Glasier utama berlaku sebanyak 11 kali",
        "Manusia mengetahui cara membuat api",
        "Manusia dipercayai sampai ke Australia melalui Pentas Sunda sekitar 50,000 tahun dahulu",
      ],
    },
    {
      name: "Zaman Holosen",
      duration: "10,000 tahun dahulu hingga kini",
      facts: [
        "Kemajuan besar dalam kehidupan manusia",
        "Manusia mengetahui aktiviti pertanian",
        "Roda dan tulisan kuneiform dicipta kira-kira 5,500 tahun dahulu",
        "Tamadun berkembang dalam keagamaan, pendidikan, pentadbiran, undang-undang",
      ],
    },
  ],
  ...
  southeastAsiaEffects: {
    ...
    culturalSignificance:
      "Manusia di rantau Asia Tenggara khususnya Pentas Sunda berkongsi tamadun yang sama — kepercayaan, asal usul keturunan, bahasa, budaya dan masyarakat. Contohnya, penduduk Malaysia, Indonesia, selatan Thailand dan selatan Filipina berkongsi bahasa Melayu.",
  ...
  chapterSummary:
    "Bab 2 menerangkan pembentukan fizikal bumi sejak 650 juta tahun dahulu, konsep Zaman Air Batu dan empat tahapnya (Miosen, Pliosen, Pleistosen, Holosen), ciri-ciri Zaman Air Batu Akhir (jambatan darat, kehidupan nomad, haiwan berbulu tebal), perubahan yang berlaku (kenaikan aras laut, pembentukan tasik, kepupusan haiwan), serta kesan khusus di Asia Tenggara melalui Pentas Sunda yang menghubungkan rantau ini sebagai satu daratan dan asas perkongsian bahasa serta budaya Melayu.",
};
