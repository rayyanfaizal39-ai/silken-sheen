...
function makeSeeds(): QuizSeed[] {
  ...
  for (let i = 0; i < 30; i++) {
    ...
    seeds.push([
      ...
      0,
      "Semakan akhir mengelakkan kesilapan lazim dalam Bab 8. Contoh rujukan: " + t.example + ".",
    ]);
  }
  return seeds;
}

export const mathF2C8QuizzesBM: QuizQuestion[] = buildQuiz(makeSeeds());
