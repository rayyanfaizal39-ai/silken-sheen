...
export const scienceF2C10MindMapBM: MindNode = {
  id: "root",
  label: "Gelombang Bunyi",
  children: [
    {
      id: "c1",
      label: "10.1 Ciri-Ciri Gelombang Bunyi",
      children: [
        {
          id: "c1-1",
          label: "Maksud Bunyi",
          children: [
            { id: "c1-1-1", label: "Bunyi ialah satu bentuk tenaga yang disebabkan oleh getaran" },
            { id: "c1-1-2", label: "Contoh: alat muzik menghasilkan bunyi melalui getaran" },
            { id: "c1-1-3", label: "Getaran pita suara dapat dirasakan di tekak semasa bercakap" },
          ],
        },
        {
          id: "c1-2",
          ...
          children: [
            { id: "c1-2-1", label: "Bunyi tidak dapat merambat melalui vakum (kawasan tanpa udara)" },
            {
              ...
              children: [
                ...
                { id: "c1-2-2-3", label: "Pemerhatian: bunyi loceng tidak dapat didengar — membuktikan bunyi memerlukan medium" },
              ],
            },
          ],
        },
        {
          id: "c1-3",
          label: "Kelajuan Bunyi dalam Pelbagai Medium",
          children: [
            { id: "c1-3-1", label: "Paling cepat dalam pepejal — zarah tersusun rapat, getaran cepat dipindahkan ke zarah berdekatan" },
            { id: "c1-3-2", label: "Kurang cepat dalam cecair berbanding pepejal — susunan zarah lebih longgar" },
            { id: "c1-3-3", label: "Paling perlahan dalam gas — zarah jauh antara satu sama lain, lambat memindahkan getaran" },
          ],
        },
        {
          id: "c1-4",
          label: "Pemindahan Bunyi",
          children: [
            { id: "c1-4-1", label: "Loceng dibunyikan → permukaan logam loceng bergetar" },
            { id: "c1-4-2", label: "Molekul udara berdekatan turut bergetar dan berlanggar dengan molekul udara lain" },
            { id: "c1-4-3", label: "Getaran dipindahkan dari satu molekul ke molekul lain dalam bentuk gelombang" },
            { id: "c1-4-4", label: "Bunyi akhirnya didengar oleh pendengar" },
          ],
        },
        {
          id: "c1-5",
          label: "Pantulan dan Penyerapan Bunyi",
          children: [
            { id: "c1-5-1", label: "Sifat sama seperti sifat cahaya (dipelajari di Tingkatan 1)" },
            { id: "c1-5-2", label: "Jumlah bunyi dipantul/diserap bergantung jenis permukaan objek" },
            { id: "c1-5-3", label: "Permukaan keras dan licin = pemantul bunyi yang baik (contoh: jubin marmar, dinding)" },
            { id: "c1-5-4", label: "Permukaan lembut dan kasar = penyerap bunyi yang baik (contoh: karpet, papan lembut/softboard)" },
            {
              id: "c1-5-5",
              label: "Aktiviti perbandingan permukaan",
              children: [
                { id: "c1-5-5-1", label: "Bahan diuji: papan kayu, kepingan logam, tuala" },
                { id: "c1-5-5-2", label: "Permukaan logam (keras, licin) memantulkan bunyi dengan baik" },
                { id: "c1-5-5-3", label: "Tuala (lembut, kasar) menyerap bunyi dengan baik" },
              ],
            },
          ],
        },
        ...
        },
        {
          ...
          label: "Kata Kunci",
          children: [
            { id: "c1-7-1", label: "Getaran" },
            { id: "c1-7-2", label: "Medium" },
            { id: "c1-7-3", label: "Gelombang" },
            { id: "c1-7-4", label: "Amplitud" },
            { id: "c1-7-5", label: "Frekuensi" },
            { id: "c1-7-6", label: "Pantulan bunyi" },
            { id: "c1-7-7", label: "Penyerapan bunyi" },
          ],
        },
        {
          id: "c1-8",
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: "c2-2-3", label: "Contoh: cara menekan kekunci piano menentukan kekuatan bunyi yang dihasilkan" },
          ],
        },
        {
          id: "c2-3",
        ...
        },
        {
          ...
          label: "Kesan Doppler",
          children: [
            { id: "c2-5-1", label: "Maksud: perubahan ketara dalam frekuensi disebabkan pergerakan relatif sumber bunyi, pemerhati, atau kedua-duanya" },
            { id: "c2-5-2", label: "Frekuensi siren ambulans meningkat apabila ambulans mendekati pemerhati yang pegun" },
    ...
    {
      id: "c3",
      label: "10.3 Fenomena dan Aplikasi Pantulan Gelombang Bunyi",
      children: [
        {
          id: "c3-1",
          label: "Pengenalan",
        ...
        {
          id: "c3-3",
          label: "Ultrabunyi (Ultrasound)",
          children: [
            { id: "c3-3-1", label: "Gelombang bunyi dengan frekuensi lebih daripada 20,000 Hz" },
            { id: "c3-3-2", label: "Tidak dapat didengar oleh manusia" },
            { id: "c3-3-3", label: "Dapat didengar oleh haiwan seperti kelawar, yang menggunakannya untuk navigasi dan anggaran jarak dalam gelap" },
            { id: "c3-3-4", label: "Contoh: ultrabunyi digunakan untuk mengimbas keadaan fetus dalam rahim (sonogram)" },
          ],
        },
        {
          id: "c3-4",
          label: "Sonar",
          children: [
            { id: "c3-4-1", label: "Teknologi pantulan bunyi yang digunakan dalam industri perkapalan untuk mengesan objek bawah air" },
            { id: "c3-4-2", label: "Juga digunakan dalam sektor perubatan dan perikanan" },
          ],
        },
        {
          id: "c3-5",
          label: "Had Pendengaran Manusia",
          children: [
            { id: "c3-5-1", label: "Manusia dapat mengesan frekuensi bunyi dalam julat 20 Hz hingga 20,000 Hz" },
            { id: "c3-5-2", label: "Julat semakin mengecil dengan usia kerana telinga kehilangan kepekaan terhadap frekuensi bunyi" },
            { id: "c3-5-3", label: "Haiwan seperti kelawar, lumba-lumba dan anjing mempunyai julat pendengaran lebih tinggi berbanding manusia" },
            {
              id: "c3-5-4",
              label: "Jadual Julat Pendengaran Haiwan (Hz)",
              children: [
                { id: "c3-5-4-1", label: "Kelawar: 2,000–110,000" },
                { id: "c3-5-4-2", label: "Lumba-lumba: 40–100,000" },
                { id: "c3-5-4-3", label: "Anjing: 67–45,000" },
                { id: "c3-5-4-4", label: "Gajah: 16–12,000" },
                { id: "c3-5-4-5", label: "Kuda: 55–33,500" },
              ],
            },
          ],
        },
