  ...
  sections: [
    {
      ...
      matcher: { title: "Padankan ujian makanan", instruction: "Padankan nutrien dengan reagen dan keputusan positif.", pairs: [
        { id: "starch", label: "Kanji", match: "Larutan iodin → biru kehitaman" }, { id: "sugar", label: "Gula penurun", match: "Larutan Benedict + haba → mendakan merah bata" }, { id: "protein", label: "Protein", match: "Ujian Biuret → ungu" }, { id: "fat", label: "Lemak", match: "Ujian emulsi etanol → putih susu" },
      ]},
