...
export const scienceF2C13QuizzesBM: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ["Jasad besar berbatu sahaja", "Sekeping logam yang terapung di angkasa lepas", "Jasad kecil terdiri daripada campuran ais, gas dan debu yang membeku, bergerak mengelilingi Matahari", "Planet kecil dalam jalur asteroid"],
    answerIndex: 2,
  ...
  },
  {
    ...
    options: ["Tidak ada perbezaan, keduanya sama", "Meteor ialah objek di angkasa lepas, meteoroid ialah objek yang sampai ke permukaan Bumi", "Meteoroid ialah objek di angkasa lepas, meteor ialah meteoroid yang terbakar memasuki atmosfera Bumi", "Meteoroid hanya wujud di Jalur Kuiper"],
    answerIndex: 2,
  ...
  },
  {
    ...
    options: ["Perlanggaran langsung pertama komet dengan objek dalam sistem suria yang pernah direkodkan", "Komet itu menjadi asteroid selepas melepasi Musytari", "Musytari menarik komet itu ke dalam jalur asteroid", "Ia adalah kali pertama meteoroid jatuh ke Musytari"],
    answerIndex: 0,
  ...
  },
  {
    ...
    options: ["Ia membawa kepada penemuan jalur asteroid", "Ia adalah meteorit pertama yang dijumpai di Bumi", "Ia adalah satu-satunya meteorit yang mengandungi ais", "Ia merupakan meteorit terbesar yang pernah direkodkan di dunia"],
    answerIndex: 3,
  ...
  },
  {
    ...
    chapter: "Chapter 13",
    lang: "bm",
    question: "Orbit Apollo, Amor dan Aten dianggap berisiko lebih tinggi berbanding asteroid lain dalam jalur asteroid. Mengapa?",
    options: ["Kerana orbitnya boleh bersilang dengan orbit Bumi, di luar jalur asteroid", "Kerana ia bergerak lebih perlahan daripada asteroid lain", "Kerana ia diperbuat daripada bahan yang lebih ringan", "Kerana ia sentiasa berada jauh daripada Matahari"],
    answerIndex: 0,
    explanation: "Orbit Apollo, Amor dan Aten adalah contoh orbit asteroid di luar jalur asteroid yang boleh bersilang dengan orbit Bumi, meningkatkan risiko perlanggaran berbanding asteroid yang kekal dalam jalur asteroid.",
  },
  {
  ...
  },
  {
    ...
    answerIndex: 3,
    explanation: "Meteoroid (serpihan kecil batu/logam), asteroid (jasad besar berbatu/logam dalam jalur asteroid) dan komet (jasad ais/gas/debu berorbit elips) mempunyai saiz, komposisi dan ciri orbit yang berbeza, menjadikan setiap satu kategori objek sistem suria yang tersendiri.",
  },
];
