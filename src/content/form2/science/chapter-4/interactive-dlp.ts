...
export const scienceF2C4InteractiveDLP: ScienceF2InteractiveContent = {
  ...
  sections: [
    {
      number: "4.1", title: "Infectious and Non-infectious Diseases", intro: "Diseases differ in cause, transmission and prevention. Infectious diseases can spread; non-infectious diseases cannot.",
      ...
      accordions: [
        ...
        { title: "Vectors", body: "Mosquitoes, flies and other animals carry pathogens between hosts. Remove breeding sites and control vector populations." },
      ],
      matcher: { title: "Match the vector to its pathogen", instruction: "Choose a vector, then the disease or pathogen it transmits.", pairs: [
        ...
        { id: "anopheles", label: "Anopheles mosquito", match: "Plasmodium that causes malaria" },
        { id: "fly", label: "Housefly", match: "Cholera-causing bacteria on contaminated food" },
        { id: "rat", label: "Rat flea", match: "Bacterium that causes plague" },
      ]},
