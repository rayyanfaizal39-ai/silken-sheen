...
export const sej3Ch1Content: Sej3Ch1Content = {
  hook: {
  ...
  stability: {
    ...
    preColonialEvidence: "1759: Batu Uban dibuka oleh orang Melayu dari Sumatera — bukti penempatan tersusun sudah wujud di Pulau Pinang 27 tahun sebelum kedatangan Francis Light",
    governance: [
  ...
  keyExamFacts: [
    "1759: Batu Uban dibuka oleh orang Melayu dari Sumatera — bukti kestabilan penempatan sebelum kedatangan Barat",
  ...
  keyTerms: [
    "Penghulu", "Penggawa", "Adat Perpatih", "Hukum Kanun Melaka", "Syahbandar", "Batu Uban",
