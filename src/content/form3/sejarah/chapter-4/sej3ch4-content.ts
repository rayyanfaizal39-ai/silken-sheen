...
export const sej3Ch4Content: Sej3Ch4Content = {
  hook: {
  ...
  stateGovernance: [
    ...
    {
      state: "Kelantan",
      background: ["Disatukan di bawah Long Yunus (1776-1794), menaiki takhta bergelar Yang Dipertuan", "1904: negeri dibahagikan kepada 3 jajahan (Selatan Batu Mekebang, Pasir Puteh, Pasir Mas) — kini berkembang kepada 11 jajahan"],
      administration: ["Sistem Jemaah Menteri dibentuk oleh Sultan Muhammad II (1839-1886)", "Peringkat paling bawah diketuai Tok Kweng (turut digelar Penggawa), dibantu seorang imam sebagai orang tengah antara penduduk kampung dengan pembesar/istana"],
      foreignRelations: ["1812: Sultan Muhammad I termeterai pakatan dengan Siam bagi mengelak ancaman Terengganu, menerima gelaran 'Phya Pipit Pakdi' daripada raja Siam", "Pengaruh Siam berterusan ke atas Kelantan sehingga 1909"],
      legalSystem: ["Pemerintahan Sultan Muhammad II membenarkan penguatkuasaan undang-undang syarak, menjadikan Kelantan aman dan makmur sebagai pusat perdagangan"]
    },
    {
      state: "Terengganu",
      background: ["Diasaskan Sultan Zainal Abidin I, menaiki takhta 1708, memerintah hingga 1733"],
      administration: ["Sistem penghulu disempurnakan semasa pemerintahan Sultan Omar (1839-1876)", "Pemerintahan Sultan Zainal Abidin III dibantu Tengku Musa, Tuan Hitam dan Che Abdul Rahim", "Seorang pembesar bergelar Dato' Mata-mata bertanggungjawab menyambut tetamu dan pembesar yang berkunjung", "Sistem Jemaah Mesyuarat Kerajaan dibentuk untuk memutuskan hukuman dan pengisytiharan negeri, ahlinya digelar Ahli Mesyuarat"],
      foreignRelations: [],
      legalSystem: ["Sistem keadilan berteraskan Islam sejak pemerintahan Sultan Zainal Abidin I", "Semasa pemerintahan Sultan Zainal Abidin III, Tengku Musa dilantik Ketua Jabatan Mahkamah", "1911: Undang-Undang Bagi Diri Kerajaan Terengganu dirangka dan diperkenalkan", "Terengganu merupakan negeri terakhir antara 5 buah NNMTB menerima Penasihat British"]
    },
    {
      state: "Johor",
  ...
  bangkokTreatyPath: {
    ...
    initialRejection: "Pada tahap awal, Kelantan dan Terengganu menolak kehadiran Penasihat British — Terengganu akhirnya menjadi negeri terakhir antara kelima-lima NNMTB menerima Penasihat British"
  },
  johorExpansion: {
  ...
  keyExamFacts: [
    ...
    "Kelantan disatukan di bawah Long Yunus (1776-1794); Sultan Muhammad II (1839-1886) membentuk Sistem Jemaah Menteri",
    "1812: Sultan Muhammad I Kelantan berpakat dengan Siam, menerima gelaran 'Phya Pipit Pakdi'",
    "Terengganu diasaskan Sultan Zainal Abidin I (1708-1733); sistem penghulu disempurnakan Sultan Omar (1839-1876)",
    "1911: Undang-Undang Bagi Diri Kerajaan Terengganu diperkenalkan semasa Sultan Zainal Abidin III",
    "Terengganu ialah negeri terakhir antara 5 NNMTB menerima Penasihat British",
  ...
  keyTerms: [
    ...
    "Long Yunus", "Sultan Muhammad II", "Phya Pipit Pakdi", "Sultan Zainal Abidin I", "Sultan Omar",
