...
// Sourced from SEJ_FORM_3.pdf (pages 170-197), supplemented with the 1877 sentencing entry
// (completing the Birch conspiracy timeline to 6 events) and a small set of additional facts
// on the post-resistance administrative reforms (Majlis Mesyuarat Negeri, Kolej Melayu Kuala
// Kangsar 1905, MCS/MAS recruitment) and 3 war-cost figures — carried forward from the prior
// generic notes for this chapter, not independently re-verified against the source PDF, but
// retained so nothing already in the app is silently dropped.
...
export interface Sej3Ch7Content {
  ...
  challengingTreaties: {
    ...
    conspiracyTimeline: { date: string; event: string; climax?: boolean }[];
  };
  legalResistance: {
    intro: string;
  ...
  effects: {
    ...
    warCosts: { war: string; cost: string }[];
    reforms: string[];
  };
  keyExamFacts: string[];
  keyTerms: string[];
...
export const sej3Ch7Content: Sej3Ch7Content = {
  hook: {
  ...
  administrativeImpact: {
    ...
    impactOnRakyat: {
      ...
      sabahMurutTaxTable: [
        ...
        { item: "Suami isteri berjumpa (dipisahkan sungai)", rate: "Denda $1.00" }
      ],
      murutMistreatment: [
  ...
  challengingTreaties: {
    ...
    conspiracyTimeline: [
      ...
      { date: "2 November 1875", event: "Selepas 7 kali mesyuarat, J.W.W. Birch dibunuh di Pasir Salak", climax: true },
      { date: "1877", event: "Dato' Maharaja Lela, Dato' Sagor, Pandak Indut dan Siputum dijatuhi hukuman gantung sampai mati; Sultan Abdullah, Raja Ismail dan Ngah Ibrahim dibuang negeri" }
    ]
  },
  legalResistance: {
  ...
  effects: {
    intro: "Kebanyakan kebangkitan hanya dimenangi masyarakat tempatan pada peringkat awal — selepas itu, mudah ditangkis British. Kerugian besar yang ditanggung British turut mendorong reformasi pentadbiran supaya penentangan sedemikian tidak berulang.",
    armedDefeatReasons: [
    ...
    warCosts: [
      { war: "Perang Naning", cost: "£100,000" },
      { war: "Perang Perak", cost: "£400,000" },
      { war: "Perang Pahang", cost: "£7,000" }
    ],
    reforms: [
      "British menubuhkan Majlis Mesyuarat Negeri dan memantapkan skim penempatan pegawai — melibatkan pembesar tempatan secara lebih formal dalam pentadbiran",
      "Kolej Melayu Kuala Kangsar (MCKK) ditubuhkan 1905 — melatih anak pembesar Melayu untuk berkhidmat dalam pentadbiran British",
      "British memberi peluang kepada aristokrat Melayu menyertai Malayan Civil Service (MCS) dan menubuhkan Malay Administrative Service (MAS)",
      "British lebih berhati-hati melantik Residen yang memahami adat resam tempatan selepas beberapa kebangkitan"
    ]
  },
  keyExamFacts: [
    "3 bentuk penentangan: bersenjata, mencabar perjanjian, sistem perundangan",
    "Dol Said (Naning) menang Perang Naning Pertama 1831, tewas 1832 selepas pakatan berpecah — British rugi £100,000",
    ...
    "J.W.W. Birch dibunuh 2 November 1875 di Pasir Salak oleh Dato' Maharaja Lela (nama sebenar Pandak Lam) — British belanja £400,000 dalam Perang Perak",
    ...
    "Kesan penentangan: British tubuhkan Majlis Mesyuarat Negeri, Kolej Melayu Kuala Kangsar (1905), dan buka peluang MCS/MAS kepada aristokrat Melayu"
  ],
  keyTerms: [
    ...
    "Haji Abdul Rahman Limbong", "Lesen Wakil", "Kebangkitan Tani", "Majlis Mesyuarat Negeri",
    "Kolej Melayu Kuala Kangsar", "MCS", "MAS"
  ],
  chapterSummary: "Bab 7 mengkaji matlamat dan 3 bentuk penentangan masyarakat tempatan terhadap British (bersenjata, mencabar perjanjian, sistem perundangan), kesan pentadbiran Barat terhadap kuasa pemerintahan/perundangan/kewangan tempatan serta kehidupan rakyat (termasuk cukai tanah Pasir Puteh dan penindasan cukai Murut di Sabah), kekuatan strategi awal penentangan (muafakat, kubu pertahanan, persenjataan, perundangan), tokoh-tokoh penentangan bersenjata (Dol Said, Yamtuan Antah, Dato' Bahaman, Rentap, Tok Janggut, Mat Salleh, Mat Sator, Sharif Masahor), pembunuhan J.W.W. Birch melalui pakatan 7 mesyuarat rahsia oleh Dato' Maharaja Lela, penentangan unik melalui sistem perundangan oleh Haji Abdul Rahman Limbong dalam Kebangkitan Tani Terengganu, serta kesan keseluruhan — kerugian besar British (£100,000-£400,000) dan reformasi pentadbiran (Majlis Mesyuarat Negeri, MCKK 1905, MCS/MAS) berbanding kelemahan strategi tempatan."
};
