...
// Sourced from SEJ_FORM_3.pdf (pages 108-135), supplemented with a small set of additional
// facts (Limbang 1890, Baron von Overbeck, SBUB charter/protectorate dates, territorial
// division structure, pre-Brooke Malay river-kingdoms and resistance figures) carried
// forward from the prior generic notes for this chapter — not independently re-verified
// against the source PDF, but retained so nothing already in the app is silently dropped.
...
export interface Sej3Ch5Content {
  ...
  localGovernance: {
    ...
    preColonialKingdoms: { intro: string; kingdoms: string[]; resistanceFigures: string[] };
  ...
  sbubExpansion: {
    ...
    charterMilestones: { year: string; event: string }[];
  };
  administration: {
...
export const sej3Ch5Content: Sej3Ch5Content = {
  hook: {
  ...
  localGovernance: {
    ...
    preColonialKingdoms: {
      intro: "Sebelum kuasa Brunei dan Sulu mendominasi, Sarawak mempunyai beberapa kerajaan Melayu kecil sendiri.",
      kingdoms: ["Sawaku", "Kalaka", "Samadong", "Melano"],
      resistanceFigures: ["Syarif Osman", "Datu Kurunding"]
    },
    tribalSystem: {
  ...
  brookeExpansion: {
    ...
    treaties: [
      ...
      { year: "1890", parties: "Charles Brooke dengan Sultan Abdul Mumin", terms: ["Limbang dianeksasi ke wilayah Sarawak, melengkapkan peluasan sempadan Dinasti Brooke"] }
    ],
    consolidation: [
  ...
  sbubExpansion: {
    ...
    pretapakanChain: [
      ...
      { figure: "Alfred Dent, Edward Dent dan Baron von Overbeck", action: "Memajak pantai timur Sabah daripada Sultan Brunei/Sulu — akhirnya membentuk SBUB" }
    ],
    charterMilestones: [
      { year: "1881", event: "SBUB menerima piagam diraja British" },
      { year: "1888", event: "Sabah menjadi negeri naungan (protectorate) British" }
    ]
  },
  administration: {
    sarawak: {
    ...
    territorialDivision: "Brooke membahagikan Sarawak kepada bahagian dan daerah; SBUB membahagikan Sabah kepada residensi dan daerah. Pentadbiran Sabah diketuai seorang Gabenor yang bertanggungjawab kepada lembaga pengarah syarikat di London."
  },
  keyExamFacts: [
    "27 etnik di Sarawak, 34 etnik di Sabah",
    "Kerajaan Melayu awal Sarawak: Sawaku, Kalaka, Samadong, Melano",
    ...
    "1890: Limbang dianeksasi ke Sarawak (perjanjian dengan Sultan Abdul Mumin)",
    ...
    "Rantaian pemilikan Sabah: Charles Lee Moses (1865) → J.W. Torrey & T.B. Harris → Alfred & Edward Dent dan Baron von Overbeck → SBUB",
    "1881: SBUB menerima piagam diraja; 1888: Sabah menjadi negeri naungan British",
    ...
    "Sarawak dibahagi kepada bahagian dan daerah; Sabah dibahagi kepada residensi dan daerah di bawah Gabenor SBUB"
  ],
  keyTerms: [
    ...
    "Fort Margherita", "Renjer Sarawak", "Limbang", "Alexander Dalrymple", "Charles Lee Moses",
    "Baron von Overbeck", "SBUB", "Temenggung", "Mahkamah Cina", "Mahkamah Anak Negeri"
  ],
  chapterSummary: "Bab 5 mengkaji latar belakang pemerintahan tempatan di Sarawak dan Sabah (sistem kesukuan, pengaruh Brunei), peluasan kuasa Dinasti Brooke di Sarawak melalui 4 strategi dan perjanjian 1841/1842/1890, peluasan kuasa Syarikat Borneo Utara British di Sabah melalui rantaian pemilikan (Moses-Torrey/Harris-Dent/Overbeck), serta bentuk pentadbiran Barat di kedua-dua negeri (dasar pecah-perintah berasaskan kaum di Sarawak, pentadbiran berasaskan peribumi di Sabah, sistem mahkamah dan pembahagian wilayah masing-masing)."
};
